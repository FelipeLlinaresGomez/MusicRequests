...
namespace MusicRequests.Core.Services
{
    ...
    public class CryptoObjectHelper
    {
        ...
        public static readonly string KEY_NAME = "es.MusicRequests.v2.piloto.fingerprint_authentication_key";
        // Hack: Descomentar para la rama Release Pro
        //public static readonly string KEY_NAME = "es.MusicRequests.fingerprint_authentication_key";
                                  ...
                                  IvParameterSpec ivParams = null)
        {
            ...
            catch (KeyPermanentlyInvalidatedException e)
            {
                ...
                if (retry)
                {
                    return CreateCipher(false, mode, theKeyName, ivParams);
                }
                else
                {
