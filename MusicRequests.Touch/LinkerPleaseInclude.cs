...
namespace MusicRequests.Touch
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        {
            service = new MvxNavigationService(loader, dispatcher, null);
        }
        ...
        public void Include(WebKit.WKWebView webkit)
        {
            webkit.LoadRequest(null);
        }
        ...
        public void Include(System.Globalization.ThaiBuddhistCalendar calendar)
        {
            calendar = new System.Globalization.ThaiBuddhistCalendar();
        }

        public void Include(System.Globalization.UmAlQuraCalendar calendar)
        {
